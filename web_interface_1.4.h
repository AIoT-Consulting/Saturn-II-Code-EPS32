...
<script src="https://aiot-consulting.github.io/Static-Assets/gauge.js" async defer></script>
  ...
  <center><footer div class="foot">Powered by AIoT Consulting - Firmware:  <span style="font-size: 16px; color: lightgrey;" id="firmwareValue"> ...</span></div></footer></center>
...
// function to handle the response from the ESP
    ...
    function response(){
      ...
      // Firmware
      xmldoc = xmlResponse.getElementsByTagName("FW");
      message = xmldoc[0].firstChild.nodeValue;
      document.getElementById("firmwareValue").innerHTML = message;
    }
